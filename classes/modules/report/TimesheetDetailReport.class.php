...
//				}
	...
	function timesheetHeader( $user_data ) {
		...
		$this->pdf->Cell( $total_width, $this->_pdf_scaleSize(15), $current_company->getName(), $border, 0, 'C');
		$this->pdf->Ln( $this->_pdf_scaleSize(10) );
		$this->pdf->SetFont($this->config['other']['default_font'], 'B', $this->_pdf_fontSize(12) );
		$this->pdf->Cell( $total_width, $this->_pdf_scaleSize(5), TTi18n::gettext('Employee TimeSheet'), $border, 0, 'C');
	...
	function timesheetTotal( $column_widths, $totals ) {
		...
		return TRUE;
            ...
            $TotalWorkedTime = TTDate::getTimeUnit( $totals['worked_time'] );    
	}
